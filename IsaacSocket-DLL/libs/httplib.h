...
public:
  ...
  Result PostEx(const std::string &method, const std::string &path, const Headers &headers,
                const char *body, size_t content_length, const std::string &content_type);
...
inline Result ClientImpl::PostEx(const std::string &method, const std::string &path, const Headers &headers,
                const char *body, size_t content_length, const std::string &content_type) {
  return send_with_content_provider(method, path, headers, body, content_length, nullptr, nullptr,
                                    content_type);
}
...
inline Result Client::PostEx(const std::string &method, const std::string &path, const Headers &headers,
                const char *body, size_t content_length, const std::string &content_type) {
  return cli_->PostEx(method, path, headers, body, content_length, content_type);
}
